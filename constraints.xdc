...
##Buttons
set_property PACKAGE_PIN T17 	 [get_ports shift_right]						
set_property IOSTANDARD LVCMOS33 [get_ports shift_right]
set_property PACKAGE_PIN W19 	 [get_ports shift_left]						
set_property IOSTANDARD LVCMOS33 [get_ports shift_left]
set_property PACKAGE_PIN T18 	 [get_ports shift_top]						
set_property IOSTANDARD LVCMOS33 [get_ports shift_top]
set_property PACKAGE_PIN U17 	 [get_ports shift_down]						
set_property IOSTANDARD LVCMOS33 [get_ports shift_down]
set_property PACKAGE_PIN R2 	 [get_ports enable_dots]						
set_property IOSTANDARD LVCMOS33 [get_ports enable_dots]
